...
if ($result->num_rows > 0) {
    ...
    while($row = $result->fetch_assoc()) {
     ...
     $expassmark_mm = $row['passmark_mm'];
     $expassmark_eng = $row['passmark_eng'];
     $expassmark_phy = $row['passmark_phy'];
	 $exreex = $row['re_exam'];
	 $exterms = $row['terms'];
    }
} else {
...
<head>
        ...
        <title>Said Institute | Edit Exam</title>
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="panel panel-white">
                                    <div class="panel-body">
                                        ...
                                        <?php 
                                        if ($expassmark == 0 && $expassmark_mm > 0 && $expassmark_eng > 0 && $expassmark_phy > 0) {
                                            echo '
                                        <div class="form-group">
                                            <label for="exampleInputEmail1">Passmark Mathematics</label>
                                            <input type="number" class="form-control" value="'.$expassmark_mm.'" placeholder="Enter passmark" name="passmark_mm" required autocomplete="off">
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleInputEmail1">Passmark English</label>
                                            <input type="number" class="form-control" value="'.$expassmark_eng.'" placeholder="Enter passmark" name="passmark_eng" required autocomplete="off">
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleInputEmail1">Passmark Physics</label>
                                            <input type="number" class="form-control" value="'.$expassmark_phy.'" placeholder="Enter passmark" name="passmark_phy" required autocomplete="off">
                                        </div>';
                                        }else if ($expassmark == 0 && $expassmark_mm > 0 && $expassmark_eng > 0 && $expassmark_phy == 0){
                                            echo '
                                        <div class="form-group">
                                            <label for="exampleInputEmail1">Passmark Mathematics</label>
                                            <input type="number" class="form-control" value="'.$expassmark_mm.'" placeholder="Enter passmark" name="passmark_mm" required autocomplete="off">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="number" class="form-control" value="'.$expassmark.'" placeholder="Enter passmark" name="passmark" required autocomplete="off">
                                            </div>';
                                        }
                                        ?>
