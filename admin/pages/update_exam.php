...
$sql = "UPDATE tbl_examinations SET category = '$category', subject = '$subject', exam_name = '$exam', date = '$date', duration = '$duration', passmark = '$passmark', passmark_mm = '$passmark_mm', passmark_eng = '$passmark_eng', passmark_phy = '$passmark_phy', re_exam = '$attempts', terms = '$terms' WHERE exam_id='$exam_id'";
