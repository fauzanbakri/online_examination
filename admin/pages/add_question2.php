...
$sql = "INSERT INTO tbl_questions (question_id, exam_id, type, question, option1, option2, option3, option4, answer, time_add)
VALUES ('$question_id', '$examid', 'MC', '$question', '$opt1', '$opt2', '$opt3', '$opt4', '$answer', now())";
...
$sql = "INSERT INTO tbl_questions (question_id, exam_id, type, question, answer, time_add)
VALUES ('$question_id', '$examid', 'FB', '$question', '$answer', now())";
