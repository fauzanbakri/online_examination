...
<head>
        ...
        <title>Said Institute | Manage Examinations</title>
                        ...
                        <div class="sidebar-profile">
                            <a href="javascript:void(0);" id="profile-menu-link">
                                ...
                                <div class="sidebar-profile-details">
                                    <span><?php echo "$myfname"; ?> <?php echo "$mylname"; ?><br><small>Said Institute Administrator</small></span>
                                </div>
                            </a>
                        </div>
                    </div>
                                ...
                                <div class="panel panel-white">
                                    <div class="panel-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select id="selectQuestionType" class="form-control" name="code" required autocomplete="off">
                                            <option value="" selected disabled>-Question Type</option>
                                            <option value="general">General</option>
                                            <option value="sipencatar1">SIPENCATAR 1</option>
                                            <option value="sipencatar2">SIPENCATAR 2</option>
                                            </select>
                                        </div>
										<div class="form-group">
										...
										<div id="passmark_general" class="form-group">
                                            <label for="exampleInputEmail1">Passmark</label>
                                            <input id="input_general" type="number" class="form-control" placeholder="Enter passmark" name="passmark" autocomplete="off">
                                        </div>
                                        <div id="passmark_mm" class="form-group">
                                            <label for="exampleInputEmail1">Passmark Mathematics</label>
                                            <input id="input_mm" type="number" class="form-control" placeholder="Enter passmark" name="passmark_mm" autocomplete="off">
                                        </div>
                                        <div id="passmark_eng" class="form-group">
                                            <label for="exampleInputEmail1">Passmark English</label>
                                            <input id="input_eng" type="number" class="form-control" placeholder="Enter passmark" name="passmark_eng" autocomplete="off">
                                        </div>
                                        <div id="passmark_phy" class="form-group">
                                            <label for="exampleInputEmail1">Passmark Physics</label>
                                            <input id="input_phy" type="number" class="form-control" placeholder="Enter passmark" name="passmark_phy" autocomplete="off">
                                        </div>
										<div class="form-group">
...
<script type="text/javascript">
    var el = document.getElementById("selectQuestionType");
    el.addEventListener("change", function() {
      if (this.selectedIndex === 1) {
        document.querySelector('#passmark_general').style.display = 'block';
        document.querySelector('#passmark_mm').style.display = 'none';
        document.querySelector('#passmark_eng').style.display = 'none';
        document.querySelector('#passmark_phy').style.display = 'none';
        document.querySelector('#input_general').setAttribute("required", "true");
      } else if (this.selectedIndex === 2) {
        document.querySelector('#passmark_general').style.display = 'none';
        document.querySelector('#passmark_phy').style.display = 'none';
        document.querySelector('#passmark_mm').style.display = 'block';
        document.querySelector('#passmark_eng').style.display = 'block';
        document.querySelector('#input_mm').setAttribute("required","true");
        document.querySelector('#input_eng').setAttribute("required","true");
      }else if (this.selectedIndex === 3) {
        document.querySelector('#passmark_general').style.display = 'none';
        document.querySelector('#passmark_mm').style.display = 'block';
        document.querySelector('#passmark_eng').style.display = 'block';
        document.querySelector('#passmark_phy').style.display = 'block';
        document.querySelector('#input_mm').setAttribute("required","true");
        document.querySelector('#input_eng').setAttribute("required","true");
        document.querySelector('#input_phy').setAttribute("required","true");
      }
    }, false);

</script>
<style type="text/css">
    #passmark_general,#passmark_mm,#passmark_eng,#passmark_phy {
  display:none;
}
</style>
    </body>
