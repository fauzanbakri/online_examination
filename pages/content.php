...
<head>
  ...
  <!--<![endif]-->
  <title>Said Institute | Password Reset</title>
  <style type="text/css">
    *{
            margin:0;
            padding:0;
...
<body bgcolor="#f6f6f6">
  <span class="preheader" style="display: none !important; visibility: hidden; opacity: 0; color: transparent; height: 0; width: 0;">
    You’re back in Examination System
</span>
            ...
            <td>
              <div class="content">
                <table class="content-message">
                  ...
                  <tr>
                    <td align="left">
                      <a href="http://said-institute.rf.gd">
                        <img src="http://said-institute.rf.gd/kashipara.png" width="126" border="0">
                      </a>
                    </td>
                  </tr>
                  <tr>
                    <td class="content-message" style="font-family:'Open Sans Light',Calibri, Arial, sans-serif; color: #595959;">
                      ...
                      <h1 style="font-family:'OpenSans-Light', Helvetica, Calibri, Arial, sans-serif;">
                                            Your new Said Institute Examination password
                                        </h1>

                      <p style="font-family: 'Open Sans','Helvetica Neue', 'Helvetica',Calibri, Arial, sans-serif; font-size:18px; line-height:26px;">Your Said Institute Examination password has been updated and it works like a charm. Nice job. <br><br><br>Here your new password :</p>
                      <p style="font-family: 'Open Sans','Helvetica Neue', 'Helvetica',Calibri, Arial, sans-serif; font-size:18px; margin-bottom: -30px; line-height:26px;">&nbsp;</p>
                      <table width="325" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                          <td width="325" height="60" bgcolor="#31cccc" style="text-align:center;">
                            <a align="center" style="display:block; font-family:'Open Sans',Calibri, Arial, sans-serif;; font-size:20px; color:#ffffff; text-align: center; line-height:60px; display:block; text-decoration:none;">passssssssssssssswwwwwwwwoooorrrrdddddddd</a>
                          </td>
                          <td>&nbsp;</td>
                          <td>&nbsp;</td>
                        </tr>
                      ...
                      <p style="font-family: 'Open Sans','Helvetica Neue', 'Helvetica',Calibri, Arial, sans-serif; font-size:18px; line-height:26px;">If you didn’t just reset your password, get in touch with the Said Institute Examination Heads so we can help secure your account. Call us at
                        <a href="tel:6282191948373" style="color:#33CCCC; font-weight:bold; text-decoration:none;">62-8219-1948-373 (Fauzan) </a>or email us at
                        <a href="mailto:fzn110120@gmail.com" style="color:#33CCCC; font-weight:bold; text-decoration:none; ">fzn110120@gmail.com</a>.</p>
                      <p style="font-family: 'Open Sans','Helvetica Neue', 'Helvetica',Calibri, Arial, sans-serif; font-size:18px; line-height:26px;">
                        <img border="0" src="https://gallery.mailchimp.com/d42c37cf5f5c0fac90b525c8e/images/4d4431c8-e778-47ac-a026-a869106b2903.gif" height="50" width="200">
                      </p>
                    </td>
            ...
            <td bgcolor="#F7F7F7" style="max-width:600px; margin:0 auto; padding:20px 33px 20px 37px; display:block;">
              <table cellspacing="0" cellpadding="10" width="100%">
                    ...
                    <table cellpadding="0" cellspacing="0" width="100%">
                      <tr>
                        ...
                        <td align="right" style="text-align:right;">
                          <a href="mailto:fzn110120@gmail.com" style="text-decoration: none; font-size:10px; font-weight:bold; font-family: 'Open Sans','Helvetica Neue', 'Helvetica',Calibri, Arial, sans-serif;color: #414141;" title="fzn110120@gmail.com">fzn110120@gmail.com</a>                          <span style="text-decoration: none; font-size:9px; font-weight:bold; font-family: 'Open Sans','Helvetica Neue', 'Helvetica',Calibri, Arial, sans-serif;color: #414141;">|</span>

                          <a style="text-decoration: none; font-size:10px; font-weight:bold; font-family: 'Open Sans','Helvetica Neue', 'Helvetica',Calibri, Arial, sans-serif;color: #414141;" href="tel:6282191948373">62-8219-1948-373 (Fauzan)</a>
                        </td>
                      </tr>
                    </table>
                  </td>
                ...
                <tr>
                  ...
                  <td colspan="2" style="font-size:10px; font-weight:normal; font-family: 'OpenSans', helvetica, sans-serif; color: #414141; text-align:right;" align="right">JL. Beroanging no. 27, Biring Kanaya, Makassar &copy; 2020 Said Institute</td>
                </tr>
              </table>
            </td>
          </tr>
