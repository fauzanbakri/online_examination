...
<head>
  ...
  <!--<![endif]-->
  <title>Said Institute | Verification</title>
  <style type="text/css">
    *{
            margin:0;
            padding:0;
                  ...
                  <tr>
                    <td class="content-message" style="font-family:'Open Sans Light',Calibri, Arial, sans-serif; color: #595959;">
                      ...
                      <h1 style="font-family:'OpenSans-Light', Helvetica, Calibri, Arial, sans-serif;">
                                            Your new Said Institute Examination Account
                                        </h1>

                      <p style="font-family: 'Open Sans','Helvetica Neue', 'Helvetica',Calibri, Arial, sans-serif; font-size:18px; line-height:26px;">This email is used for Said Institute Online Examination account, to Verify is that you please click the button <br><br><br></p>
                      ...
                      <table width="325" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                          <td width="325" height="60" bgcolor="#31cccc">
                            <a align="center" href="linnnnnnkkkkkkkkkkkk" style="display:block; font-family:'Open Sans',Calibri, Arial, sans-serif;; font-size:20px; color:#ffffff; text-align: center; line-height:60px; display:block; text-decoration:none;">Active Account</a>
                          </td>
                          <td>&nbsp;</td>
                          <td>&nbsp;</td>
                        </tr>
                      ...
                      <p style="font-family: 'Open Sans','Helvetica Neue', 'Helvetica',Calibri, Arial, sans-serif; font-size:18px; line-height:26px;">If you didn’t just use this email, please ignore this email. <br> Thank you. <br><br> 
                        <a href="tel:6282191948373" style="color:#33CCCC; font-weight:bold; text-decoration:none;">62-8219-1948-373 (Fauzan) </a><br>
