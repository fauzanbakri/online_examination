...
$sql2 = "SELECT * FROM tbl_examinations WHERE exam_id = '$exam_id'";
$result2 = $conn->query($sql2);
    while($row2 = $result2->fetch_assoc()) {
    $passmark = $row2['passmark'];
    $passmark_mm = $row2['passmark_mm'];
    $passmark_eng = $row2['passmark_eng'];
    $passmark_phy = $row2['passmark_phy'];
    }
if ($result->num_rows > 0) {
	...
	$score = $row['score'];
    $score_mm = $row['score_mm'];
    $score_eng = $row['score_eng'];
    $score_phy = $row['score_phy'];
	$status = $row['status'];
...
<head>
        ...
        <title>SAID Institute | Take Assessment</title>
                               ...
                               <table class="table">
                                   <tbody>
                                       ...
                                       <?php if($code=='S1'){ ?>
                                         <tr>
                                           <td>Mathematics</td>
                                           <td><?php echo "$score_mm"; ?></td>
                                           <td><?php echo "$passmark_mm"; ?></td>
                                           <td><?php if ($score_mm>=$passmark_mm){
                                            echo "<p style='color:green;'>PASS</p>";}else
                                            {
                                            echo "<p style='color:red;'>FAIL</p>";}?></td>
                                       </tr>
                                         <tr>
                                           <td>English</td>
                                           <td><?php echo "$score_eng"; ?></td>
                                           <td><?php echo "$passmark_eng"; ?></td>
                                           <td><?php if ($score_eng>=$passmark_eng){
                                            echo "<p style='color:green;'>PASS</p>";}else
                                            {
                                            echo "<p style='color:red;'>FAIL</p>";}?></td>
                                       </tr>
                                       <?php }
                                         ...
                                         <tr>
                                           <td>Physics</td>
                                           <td><?php echo "$score_phy"; ?></td>
                                           <td><?php echo "$passmark_phy"; ?></td>
                                           <td><?php if ($score_phy>=$passmark_phy){
                                            echo "<p style='color:green;'>PASS</p>";}else
                                            {
                                            echo "<p style='color:red;'>FAIL</p>";}?></td>
                                       </tr>
