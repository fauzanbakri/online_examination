...
$sql1 = "SELECT * FROM tbl_examinations WHERE exam_id = '$exam_id' AND category = '$mycategory' AND status = 'Active'";
...
if ($result->num_rows > 0) {
    ...
    $passmark_mm = $row['passmark_mm'];
    $passmark_eng = $row['passmark_eng'];
    $passmark_phy = $row['passmark_phy'];
    $reexam = $row['re_exam'];
    $terms = $row['terms'];
    $status = $row['status'];
...
$sql2 = "SELECT * FROM tbl_assessment_records WHERE student_id = '$myid'";
...
$sql3 = "INSERT INTO tbl_assessment_records (record_id, student_id, student_name, exam_name, exam_id, score, status, next_retake, date)
...
<head>
        ...
        <title>Said Institute | Examination</title>
                        ...
                        <div class="sidebar-profile">
                            <a href="javascript:void(0);" id="profile-menu-link">
                                ...
                                <div class="sidebar-profile-details">
                                    <span><?php echo "$myfname"; ?> <?php echo "$mylname"; ?><br><small>Said Institute Student</small></span>
                                </div>
                            </a>
                        </div>
                    </div>
                                ...
                                <div class="panel panel-white">
                                    <div class="panel-body">
                                       ...
                                       <form action="pages/submit_assessment.php" method="POST" name="quiz" id="quiz_form" >
											...
											$sql = "SELECT * FROM tbl_questions WHERE exam_id = '$exam_id' order by time_add";
                                            ...
                                            <input type="hidden" name="pm_mm" value="<?php echo "$passmark_mm"; ?>">
                                            <input type="hidden" name="pm_eng" value="<?php echo "$passmark_eng"; ?>">
                                            <input type="hidden" name="pm_phy" value="<?php echo "$passmark_phy"; ?>">
